        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="comment-widgets scrollable ps-container ps-theme-default" data-ps-id="a56a87d8-5d34-a8af-ba26-a3cf605d8604">
                        <!-- Comment Row -->
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="todo-widget scrollable ps-container ps-theme-default ps-active-y" style="height:450px;" data-ps-id="58db7b64-edf3-ee2a-722c-3ef66be5ab42">
                            ...
                            <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: -31px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 31px; height: 450px; right: 3px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 30px; height: 420px;"></div></div></div>
                    </div>
                </div>
                <!-- card -->
                <div class="card">
            ...
            <div class="col-lg-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="chat-box scrollable ps-container ps-theme-default ps-active-y" style="height:475px;" data-ps-id="3bbe3b58-ef69-8adb-67cf-8edc8f7e61b8">
                            <!--chat Row -->
                            <ul class="chat-list">
                                <!--chat Row -->
                                <li class="chat-item">
                            ...
                            <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: -53px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 53px; height: 475px; right: 3px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 48px; height: 427px;"></div></div></div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="comment-widgets scrollable ps-container ps-theme-default ps-active-y" style="max-height: 130px;" data-ps-id="64f95e8f-61d0-f0d1-115c-6ab27c76d520">
                        <!-- Comment Row -->
                        <div class="d-flex flex-row comment-row m-t-0">
                            <div class="p-2"><img src="../../assets/images/users/1.jpg" alt="user" width="50" class="rounded-circle"></div>
                            <div class="comment-text w-100">
                        ...
                        <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 130px; right: 3px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 38px;"></div></div></div>
                </div>
                <!-- accoridan part -->
